...
namespace PBL3
{
    public partial class Menu : Form
    {
        ...
        public Menu(int idbill, int check)
        {
            InitializeComponent();
            ID_bill = idbill;
            Check(check);
        ...
        private void LoadDGV()
        {
            ...
            dgvDatMon.Columns["ThanhTien"].HeaderText = "Thành tiền";
        }
        private void setTXB()
        {
        ...
        private void buttonDatMon_Click(object sender, EventArgs e)
        {
            ...
            if (txbSL.Text != "" && txbSL.Text != 0.ToString())
            {
                ...
                {
                    MENUDETAIL mnf = new MENUDETAIL { IDBILL = ID_bill, IDFood = f.IDFood, SLFood = Convert.ToInt32(txbSL.Text), ThanhTien = Convert.ToInt32(txbSL.Text) * f.PriceFood };
